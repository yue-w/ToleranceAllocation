function [allParts, CONST,data]=clutchrnd(maxIteration,CONSTMETHOD)
%{
Case study. The only difference between this file and clutch.m. is the
initial tolerance and initial process.
%}
num_part = 4;
%num_processes = 3;
part1_dim = 55.29;
...
init_sigma1 = (0.015+0.08)/2/KSIGMA;
...
init_sigma2 = (0.02+0.15)/2/KSIGMA;
...
init_sigma4 = (0.08+0.12)/2/KSIGMA;
