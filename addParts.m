function [parts,num_part_added] = addParts(parts,thisPart,thisProcessIndex, designDim,sigma, tol, BATCH)
...
%that satisfy dimension requirement = BATCH
    ...
    while(gap>0)
        ...
        addedParts = normrnd(thisPart.processes(thisProcessIndex).Xbar,sigma, [1,gap]);
