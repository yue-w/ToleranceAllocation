...
part1 = machinePart_sigma(part1, init_processIndex, init_sigma, CONST);
part2 = machinePart_sigma(part2, init_processIndex, init_sigma, CONST);
part3 = machinePart_sigma(part3, init_processIndex, init_sigma, CONST);
