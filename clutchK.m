...
reworkingConstVecPt = [0.5,0.5];
ub = 0.464;     
lb = ub/20;
part1_process = setprocesses(lb, ub, CST.a, CST.b, c, d,machiningConst1,reworkingConstVecPt,part1_dim,Sdev_pt1);
...
ub = 0.5616;     
lb = ub/20;
part2_process = setprocesses(lb, ub, CST.a, CST.b, c, d,machiningConst2,reworkingConstVecPt,part2_dim,Sdev_pt2);
...
ub = 0.3688;     
lb = ub/20;
part3_process = setprocesses(lb, ub, CST.a, CST.b, c, d,machiningConst3,reworkingConstVecPt,part3_dim,Sdev_pt3);
...
ub = 0.5576;     
lb = ub/20;
part4_process = setprocesses(lb, ub, CST.a, CST.b, c, d,machiningConst4,reworkingConstVecPt,part4_dim,Sdev_pt4);
